# gradnja i provera pojedinacnih linija: ono sto je svim baselinima zajednicko
import numpy as np
...
__all__ = ["is_duplicate", "terminal_nodes", "trim_to_terminals", "random_route"]
...
def random_route(city, rng, min_len, max_len):
